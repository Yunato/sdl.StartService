    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(action == Intent.ACTION_ANSWER && intent.getStringExtra(Service3.EXTRA_RTNARG) != null){
                    Toast.makeText(MainActivity.this, "Goodbye, Service3", Toast.LENGTH_SHORT).show();
                }
            }
        };
